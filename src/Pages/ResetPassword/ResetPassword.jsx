        ...
        <div className="container mx-auto ">
          <form className="flex flex-col gap-8 mb-3 w-3/4 mx-auto" onSubmit={formik.handleSubmit} >
            <div className='flex items-center text-teal-500 mt-8'>
              <h2 className='font-medium text-2xl py-3 '>Reset Password</h2>
            </div>
            ...
            <div className="relative ">
              ...
              <label htmlFor="userPassword" className="absolute text-base text-gray-700 ps-3 duration-300 transform -translate-y-6 top-3 origin-[0] peer-focus:start-0 peer-focus:text-teal-500 border-teal-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-6 ">newPassword</label>
