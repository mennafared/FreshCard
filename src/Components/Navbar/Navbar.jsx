          ...
          {!token ?
            <div>
              <ul className='flex justify-between items-center gap-3 mr-1'>
                <li className='p-2'>
                  <NavLink to="/auth/login" className="block cursor-pointer p-1 rounded-md relative before:absolute before:bottom-0 before:w-0 hover:before:w-[89%] before:transition-all before:duration-500 before:h-0.5 before:bg-teal-500">Login</NavLink>
                </li>
                <li className='p-2'>
                  <NavLink to="/auth/signup" className="block cursor-pointer p-1 rounded-md relative before:absolute before:bottom-0 before:w-0 hover:before:w-[89%] before:transition-all before:duration-500 before:h-0.5 before:bg-teal-500">SignUp</NavLink>
                </li>
