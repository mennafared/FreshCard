      ...
      <section className="login pb-5 lg:pb-0">
        <div className="container mx-auto ">
          <form className="flex flex-col gap-8 mb-3 w-3/4 mx-auto" onSubmit={formik.handleSubmit} >
            ...
            <Link to="/forgetPassword" className='pl-2 cursor-pointer text-gray-800 font-medium hover:text-teal-500'>Forget Password ?</Link>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div>
                <span>New User? </span>
                <Link to="/signup" className='text-teal-500 font-medium'>Creat Account</Link>
              </div>
            </div>
          </form>
        </div>
